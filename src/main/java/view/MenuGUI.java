...
public class MenuGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLNombreUsuario.setText("jLabel2");

        jLabel2.setText("Que quieres visitar?");

        jBCrudUser.setText("CRUD USUARIO");
        jBCrudUser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBCrudUserActionPerformed(evt);
            }
        });

        jBCrudProductos.setText("CRUD PRODUCTOS");
        jBCrudProductos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBCrudProductosActionPerformed(evt);
            }
        });
    ...
    private void jBCrudUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCrudUserActionPerformed
        // TODO add your handling code here:
        ViewGUIUser userVIew = new ViewGUIUser();
    ...
    private void jBCrudProductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCrudProductosActionPerformed
        // TODO add your handling code here:
        ViewGUIProducts productVIew = new ViewGUIProducts();
        productVIew.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jBCrudProductosActionPerformed
